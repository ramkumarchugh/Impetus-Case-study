...
import { BasePlan } from '../model/baseplan.model';
...
export class ApplicationAddComponent implements OnInit, OnDestroy {
  ...
  //  console.log(this.policyTypeId);
//    application.baseplan.basePlanId=this.policyTypeId;
//    application.baseplan.description=null;
 ...
 /*    
    "user": {
      ...
      "password": "$2a$10$bdKR9fiIj.rk7FL7yXnpke.vNSFpFMhVUw4qRyLZ3xodYdkMExgdO",
      "city": "delhi",
      "state": "MP",
      "address": "Vijay nagar",
      "dob": "1997-12-28",
  ...
  "baseplan":{
    ...
    "baseplanId":1
      ...
      var postData= {
        ...
        "age": application.age,
        "noOfYears": application.noOfYears,
        "noOfDependents": application.noOfDependents,
        "premium": this.premiumValue,
          "baseplan" :{ "baseplanId": this.policyTypeId}
      }
      console.log(postData);
  //    console.log(postData.baseblan.basePlanId);
    ...
    console.info("Which we sent:  --" +JSON.stringify(postData));
    this.restService.post<any>("api/application/", postData, null).subscribe(data => {
